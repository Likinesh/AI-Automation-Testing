...
export async function POST(req: NextRequest) {
  try {
    ...
    // Ask Gemini to generate test cases with metadata
    const prompt = `
              ...
              items: {
                ...
                properties: {
                  ...
                  type: {
                    type: Type.STRING,
                    enum: [
                      "ui","auth","api","form","integration","edge-case",
                    ],
                  },
                  priority: {
                    type: Type.STRING,
    ...
    // Save generated test cases to Neon DB
